...
st.write("فایلی SRT ئینگلیزی لۆد بکە بۆ وەرگێڕانی بێ سانسۆر بە بەکارهێنانی مۆدێلی Gemini Pro پێشکەوتوو.")

# وەرگرتنی کلیلی API
API_KEY = st.text_input("کلیلی Google AI Studio (API Key):", type="password")

# وەرگرتنی ناوی مۆدێل بە گۆڕاو
MODEL_NAME = st.text_input("ناوی مۆدێلی Gemini:", value="gemini-1.5-pro")
...
if uploaded_file is not None and API_KEY:
    ...
    if st.button("دەستپێکردنی وەرگێڕانی فۆڕمات 🚀"):
